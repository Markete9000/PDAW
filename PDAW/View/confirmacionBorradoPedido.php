...
<body class="body">
    <form class="formulario" action="../Controller/borraPedido.php" method="post">
        <h1>Confirmación de Borrado</h1>
        <div class="contenedor">
            <h3>¿Es seguro que desea borrar el pedido?</h3>
            <div class="formularios">
                ...
                <form action="../Controller/gestion_pedidos.php" method="post">
